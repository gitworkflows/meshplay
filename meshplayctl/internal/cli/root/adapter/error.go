...
var (
	...
	ErrNoAdapters = errors.New(ErrNoAdaptersCode, errors.Fatal,
		...
		[]string{"Run the appropriate Meshplay Adapter for your specific use case. See https://docs-meshplay.khulnasoft.com/concepts/architecture/adapters for list of adapters"})
