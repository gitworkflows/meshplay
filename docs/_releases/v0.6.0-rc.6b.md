...
- [meshplayctl] Fix `app onboard` silent fail @gr455 (#5679)
...
- [Cypress] Fix Failing e2e and integration tests in Meshplay @Abhishek-kumar09 (#5702)
...
- Meshplay-Settings: Enable Subscriptions and fix problems with settings page @Abhishek-kumar09 (#5645)
...
- [Docs] Add KubeSphere App Store as a supported platform for Meshplay @codrAlxx (#5717)
