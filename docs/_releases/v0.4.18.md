...
- General
  ...
  - [meshplayctl] Read user consent before starting Docker daemon in PreReqCheck @hexxdump (#1859)
  ...
  - meshplayctl installation instructructions for Brew #1785 @abhishekkumkar (#1794)
...
- Features
  ...
  - feat: add AKS support in meshplayctl @kushthedude (#1874)
