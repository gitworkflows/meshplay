...
- Already have [Meshplay Adapters](https://docs-meshplay.khulnasoft.com/concepts/architecture/adapters) up and running (Required for several test cases)
...
There is also Meshplay CLI which can help you run the UI and Server, for more detail, you go to [Meshplay CLI documentation](https://docs-meshplay.khulnasoft.com/project/contributing/contributing-cli-guide#process)
