...
- Designs can be [snapshotted](https://docs-meshplay.khulnasoft.com/extensions/snapshot). Snapshots are immutable. Snapshots can be compared for differences between Design versions.
