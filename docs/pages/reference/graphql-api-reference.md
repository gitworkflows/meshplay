...
Self-generated API documentation for Meshplay's GraphQL API. The API can be explored interactively using the [GraphQL Playground](./extensibility). Documentation is generated from Meshplay's GraphQL schema. Each table below documents a GraphQL type.
...
| <a id="mutationchangeadapterstatustargetstatus"></a>`targetStatus` | [`Status!`](#status) | Desired status for Meshplay Operator. |
...
| <a id="mutationchangeoperatorstatustargetstatus"></a>`targetStatus` | [`Status!`](#status) | Desired status for Meshplay Operator. |
...
Object types represent the resources that the Meshplay GraphQL API can return.
...
### `MeshplayControllersStatusListItem`
...
| <a id="operatorstatuscontrollers"></a>`controllers` | [`[OperatorControllerStatus!]!`](#operatorcontrollerstatus) | Details about various Controllers of Meshplay Operator. |
| <a id="operatorstatuserror"></a>`error` | [`Error`](#error) | Error Logs encountered by Meshplay Operator. |
| <a id="operatorstatusstatus"></a>`status` | [`Status!`](#status) | Status of Meshplay Operator. |
| <a id="operatorstatusversion"></a>`version` | [`String!`](#string) | Verion of Meshplay Operator. |
...
| Value | Description |
| ----- | ----------- |
| <a id="meshtypeall_mesh"></a>`ALL_MESH` | All meshes that Meshplay supports. |
