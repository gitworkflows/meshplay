...
- **spec**
  ...
  - **broker**:
    This section contains the configuration for [Broker](https://docs-meshplay.khulnasoft.com/concepts/architecture/broker)
    - **native**:
...
The Custom Resource is used to configure the [Broker](https://docs-meshplay.khulnasoft.com/concepts/architecture/broker) and Events to be tracked by [MeshSync](https://docs-meshplay.khulnasoft.com/concepts/architecture/MeshSync)
