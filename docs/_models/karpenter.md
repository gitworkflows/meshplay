...
docURL: https://docs-meshplay.khulnasoft.com/extensibility/integrations/karpenter
description: 
...
howItWorks: "Using Meshplay and Karpenter, once your Kubernetes cluster and the Karpenter controller are up and running"
