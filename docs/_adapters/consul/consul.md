...
[![Layer5 Image Hub on HashiCorp Consul]({{ site.baseurl }}/extensibility/adapters/consul/khulnasoft-image-hub-on-hashicorp-consul.png)]({{ site.baseurl }}/extensibility/adapters/consul/khulnasoft-image-hub-on-hashicorp-consul.png)
