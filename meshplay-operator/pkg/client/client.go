...
import (
	apiv1alpha1 "github.com/khulnasoft/meshplay/meshplay-operator/api/v1alpha1"
	v1alpha1 "github.com/khulnasoft/meshplay/meshplay-operator/pkg/client/v1alpha1"
