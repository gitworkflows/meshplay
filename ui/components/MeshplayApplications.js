...
import ApplicationsGrid from './MeshplayApplications/ApplicationsGrid';
...
function MeshplayApplications({ updateProgress, user, classes, selectedK8sContexts }) {
  ...
  function urlUploadHandler(link, source_type, metadata) {
    handleSubmit({
      data: link,
      id: '',
      name: 'meshplay_' + Math.floor(trueRandom() * 100),
...
export default withStyles(styles)(
  connect(mapStateToProps, mapDispatchToProps)(withSnackbar(MeshplayApplications)),
);
