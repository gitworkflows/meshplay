...
import MeshplayApplicationCard from './ApplicationsCard';
...
/**
 * MeshplayApplicationGrid is the react component for rendering grid
 * @param {{
 *  applications:Array<{
 *  id:string,
 *  created_at: string,
...
function MeshplayApplicationGrid({
  applications = [],
  handleDeploy,
  handleUnDeploy,
  handleSubmit,
...
export default MeshplayApplicationGrid;
