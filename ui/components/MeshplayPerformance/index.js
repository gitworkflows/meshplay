...
function generatePerformanceProfile(data) {
  ...
  const performanceProfileName = MeshplayPerformanceComponent.generateTestName(name, serviceMesh);
...
class MeshplayPerformanceComponent extends React.Component {
  constructor(props) {
    super(props);
    const {
      testName = '',
  ...
  submitLoadTest = (id) => {
    ...
    const computedTestName = MeshplayPerformanceComponent.generateTestName(testName, meshName);
...
MeshplayPerformanceComponent.propTypes = { classes: PropTypes.object.isRequired };
