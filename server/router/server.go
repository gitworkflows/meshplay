...
func NewRouter(_ context.Context, h models.HandlerInterface, port int, g http.Handler, gp http.Handler) *Router {
	...
	gMux.PathPrefix("/api/provider/extension").
		Handler(h.ProviderMiddleware(h.AuthMiddleware(h.SessionInjectorMiddleware(h.KubernetesMiddleware(h.MeshplayControllersMiddleware(h.ProviderComponentsHandler))), models.ProviderAuth))).
	...
	gMux.Handle("/api/system/sync", h.ProviderMiddleware(h.AuthMiddleware(h.SessionInjectorMiddleware(h.KubernetesMiddleware(h.MeshplayControllersMiddleware(h.SessionSyncHandler))), models.ProviderAuth))).
		Methods("GET")
