...
func (ec *executionContext) field_Subscription_subscribeConfiguration_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["filterSelector"]; ok {
		...
		arg2, err = ec.unmarshalNPageFilter2githubᚗcomᚋkhulnasoftᚋmeshplayᚋserverᚋinternalᚋgraphqlᚋmodelᚐPageFilter(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Query_getOperatorStatus(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return nil, fmt.Errorf(`unexpected type %T from directive, should be *github.com/khulnasoft/meshplay/server/internal/graphql/model.OperatorStatus`, tmp)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	res := resTmp.(*model.OperatorStatus)
	fc.Result = res
	return ec.marshalOOperatorStatus2ᚖgithubᚗcomᚋkhulnasoftᚋmeshplayᚋserverᚋinternalᚋgraphqlᚋmodelᚐOperatorStatus(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalOOperatorStatus2ᚖgithubᚗcomᚋkhulnasoftᚋmeshplayᚋserverᚋinternalᚋgraphqlᚋmodelᚐOperatorStatus(ctx context.Context, sel ast.SelectionSet, v *model.OperatorStatus) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._OperatorStatus(ctx, sel, v)
