...
import (
	...
	entity "github.com/khulnasoft/meshkit/models/meshmodel/entity"
...
func FailedEventCompute(hostname string, meshplayInstanceID gofrs.UUID, provider *models.Provider, userID string, ec *models.Broadcast) (string, error) {
	...
	if failedMsg != "" {
		...
		errorEventBuilder.WithMetadata(map[string]interface{}{
			...
			"SuggestedRemediation": fmt.Sprintf("Open Meshplay Error Reference with error code %s", "https://docs-meshplay.khulnasoft.com/reference/error-codes"),
